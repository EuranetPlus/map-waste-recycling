export const config = {
	mapTitle: 'map-waste-recycling', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'map-waste-recycling.vercel.app', // The url provided when deploying the map on Vercel
