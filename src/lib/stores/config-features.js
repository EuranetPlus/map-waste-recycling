export const config = {
	mapTitle: 'map-water-recycling', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'map-water-recycling.vercel.app', // The url provided when deploying the map on Vercel
